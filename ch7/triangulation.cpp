    ...
    std::vector<Point3d>& points)
{
    ...
    for ( int i = 0; i < ( int ) matches.size(); i++ )
    {
        ...
        pts_2.push_back ( pixel2cam(keypoint_2[matches[i].trainIdx].pt, K) );
    }
    ...
    for(int i = 0; i < pts_4d.cols; i++)
    {
        ...
        Mat x1 = pts_4d.col(i);
        cout << "x1 = " << x1 << endl;
        cout << "x1.at<float>(3, 0) = " << x1.at<float>(3, 0) << endl;
        x1 /= x.at<float>(3, 0);        
        cout << "x1 = " << x1 << endl;
        ...
        //x = Mat_<double>(x);
        cout << "x = " << x << endl;
        cout << "x.at<double>(3, 0) = " << x.at<double>(3, 0) << endl;
        x /= x.at<double>(3, 0);        
        cout << "x = " << x << endl;
