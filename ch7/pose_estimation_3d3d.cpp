...
int main ( int argc, char** argv )
{
    ...
    cout << "R_inv = " << R.inv() << endl;
    cout << "t_inv = " << -R.inv() * t << endl;
    

    cout<<"calling bundle adjustment"<<endl;

    //传入R, t，但函数中好像没有改变其值，最后优化出来的是T = Eigen::Isometry3d( pose->estimate() ).matrix()的齐次坐标
...
{
    // 初始化g2o
    typedef g2o::BlockSolver< g2o::BlockSolverTraits<6,1> > Block;  // pose维度为 6, landmark 维度为 3
